...
public class RegistraCarico extends JFrame {
    ...
    public RegistraCarico(Operatore operatore) {
        ...
        form.add(label("Quantità da caricare"));
        form.add(Box.createVerticalStrut(5));
        ...
        // Bottone Conferma
        btnConferma = new JButton("Conferma Carico") {
        ...
        btnConferma.addActionListener(e -> {
            JOptionPane.showMessageDialog(this, "Carico registrato con successo!", "Successo", JOptionPane.INFORMATION_MESSAGE);
